// Generated by Swift version 6.0.3 (swift-6.0.3-RELEASE)
#ifndef FCITX5HAZKEY_SWIFT_H
#define FCITX5HAZKEY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="fcitx5Hazkey",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("fcitx5Hazkey", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace fcitx5Hazkey SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("fcitx5Hazkey") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN ptrdiff_t $s12fcitx5Hazkey11hellohazkeySiyF(void) SWIFT_NOEXCEPT SWIFT_CALL; // hellohazkey()
...
class SWIFT_SYMBOL("s:12fcitx5Hazkey9KkcConfigC") KkcConfig;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<fcitx5Hazkey::KkcConfig> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_KkcConfig;
// Type metadata accessor for KkcConfig
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s12fcitx5Hazkey9KkcConfigCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:12fcitx5Hazkey9KkcConfigC") KkcConfig : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
protected:
  SWIFT_INLINE_THUNK KkcConfig(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_KkcConfig;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s12fcitx5Hazkey9KkcConfigCD;
  static inline constexpr $s12fcitx5Hazkey9KkcConfigCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_KkcConfig {
public:
static SWIFT_INLINE_THUNK KkcConfig makeRetained(void * _Nonnull ptr) noexcept { return KkcConfig(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<fcitx5Hazkey::KkcConfig> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return fcitx5Hazkey::_impl::$s12fcitx5Hazkey9KkcConfigCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<fcitx5Hazkey::KkcConfig> { using type = fcitx5Hazkey::_impl::_impl_KkcConfig; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
/// Config
SWIFT_INLINE_THUNK swift::Int hellohazkey() noexcept SWIFT_SYMBOL("s:12fcitx5Hazkey11hellohazkeySiyF") SWIFT_WARN_UNUSED_RESULT {
  return _impl::$s12fcitx5Hazkey11hellohazkeySiyF();
}


} // namespace fcitx5Hazkey
