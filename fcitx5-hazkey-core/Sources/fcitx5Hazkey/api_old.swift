...
// public func keyEvent(key: fcitx.Key) -> Int {
//   print("eee")
//   if (key.sym() == FcitxKey_0) {
//     print("zero")
//   }
//   let a = String(key.code())
//   print(a)
//   print("fff")
//   return 5
// }
...
// public struct kkcConfigContainer {
//   var kkcConfig: KkcConfig
// }
...
public func getConfig(
  ...
  let profileText = String(profileText)
...
public struct ComposingTextContainer {
  var composingText: ComposingText
}


public func getComposingTextInstance() -> ComposingTextContainer {
  let composingText = ComposingText()
  let container = ComposingTextContainer.init(composingText: composingText)
  return container
  // return composingText

  // let pointer = Unmanaged<ComposingText>.passUnretained(*composingText).toOpaque()
  // let composingTextContainer = composingTextContainer.init(composingText: composingText)
  // return composingTextContainer
}
...
public func inputText(
  composingTextContainer: ComposingTextContainer, kkcConfigPtr: UnsafeRawPointer,
  inputString: String, isDirect: Bool
) -> ComposingTextContainer {

  var inputUnicode = inputString.unicodeScalars.first!

  var composingText = composingTextContainer.composingText

  // let config: KkcConfig
  // let kkcConfigPtr = kkcConfigPtr
  // config = Unmanaged<KkcConfig>.fromOpaque(UnsafeRawPointer(kkcConfigPtr))
  // .takeUnretainedValue()
  let config = Unmanaged<KkcConfig>.fromOpaque(kkcConfigPtr).takeUnretainedValue()
