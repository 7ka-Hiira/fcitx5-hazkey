...
HazkeyEngine::HazkeyEngine(Instance *instance)
    ...
    // kkcConfig_ = fcitx5Hazkey::getConfig
    
    // let swiftProfileText = config().zenzaiProfile == Option
    kkcConfig_ =
        fcitx5Hazkey::getConfig(*config().zenzaiEnabled, *config().zenzaiInferenceLimit,
